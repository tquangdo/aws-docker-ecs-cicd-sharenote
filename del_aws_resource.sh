...
# ~~~~~~~~~~~ 5) RDS ~~~~~~~~~~~
aws rds delete-db-instance --db-instance-identifier dtqinstancesharenote --skip-final-snapshot
...
# ~~~~~~~~~~~ 12) Container ~~~~~~~~~~~
## ~~~~~~~~~~~ service!!!
aws ecs delete-service --service DTQECSServiceSharenote --force --cluster DTQECSClusterSharenote

## ~~~~~~~~~~~ cluster!!!
aws ecs delete-cluster --cluster DTQECSClusterSharenote

## ~~~~~~~~~~~ task definition!!!
aws ecs deregister-task-definition --task-definition DTQTaskDefSharenote:1

## ~~~~~~~~~~~ ECR!!!
aws ecr delete-repository --force --repository-name dtq-sharenote
